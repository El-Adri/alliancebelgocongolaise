...
<body id="k">
	...
	<div id="bb">	
				<div style="border:4px solid #444; height:7px; width:40px; border-right-color:white;border-left-color:white;margin-bottom:7px;">  </div>
			    <div style="border:4px solid #444; height:7px; width:40px; margin-top:3px;border-right-color:white;border-left-color:white;border-bottom-color:white;"> </div>
	    	</div>
		<div id="par" >
		...
		<div class="logoABC" >
			<img src="logoABC.jpg" alt="logoABC"  sizes="10">
		</div>
	...
	<section id="contact">
		<div>
            ...
            <p class="gry">Vous pouvez discuter avec nous, en nous contactant quelle que soit votre question ou votre préoccupation.</p>
                ...
                <textarea rows="4" id="suggestion" placeholder="Votre préoccupation"></textarea>
